# FCS Staff — Android app

This is a **real Android application** (own package id `lk.futureshipping.staff`), not a browser bookmark.
...
<string name="start_path">staff-login.html</string>
```
...
2. **Open** this folder (`FCS-Staff`) in Android Studio
